...
Each test = num of tsk && number of test for the task
"""
...
class TestSquare(unittest.TestCase):
    ...
    def test_10_0(self):
        """Test Square class: check for att."""
    ...
    def test_10_3(self):
        """Test Square class: check for unavailable argumebts."""
    ...
    def test_11_0(self):
        """Test Square class: check for size att."""
    ...
    def test_11_1(self):
        """Test Square class: check for incorrect att."""
    ...
    def test_12_1(self):
        """Test for update method on Square with incorrect file types."""
